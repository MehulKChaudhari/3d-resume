  ...
  return (
    <main className="min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="mb-16">
          <h1 className="text-4xl sm:text-5xl font-display font-light text-text mb-2">Projects</h1>
          <p className="text-sm text-text-subtle">Engineering work and systems I've built</p>
        </div>
